//
//  TBJHorizontalMenuView.h
//  TBJPro
//
//  Created by Binbin on 17/7/18.
...
@protocol TBJHorizontalMenuViewDelegate;
@interface TBJHorizontalMenuView : UIView
...
@property(nonatomic, assign) id<TBJHorizontalMenuViewDelegate> delegate;
/** 
 showMaxChout 
...
@protocol TBJHorizontalMenuViewDelegate <NSObject>
- (void)slideMenuView:(TBJHorizontalMenuView *)view selectedIdx:(NSUInteger)idx;
@end
